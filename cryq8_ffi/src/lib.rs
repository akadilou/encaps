...
#[no_mangle]
/// # Safety
/// Pointeurs C passés doivent être valides; tampons/longueurs cohérents; appel côté FFI respecte l ABI.
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_free(p:*mut u8,_len:size_t){
    if p.is_null(){return}
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_encpwd_json(
    ...
    let pt=if data.is_null(){&[][..]}else{unsafe{slice::from_raw_parts(data,data_len)}};
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_decpwd_json(
    password:*const c_char,
    ...
    let by=unsafe{slice::from_raw_parts(cap_json,cap_len)};
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_enckp_json(
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_deckp_json(
    ...
    let cap_by=unsafe{slice::from_raw_parts(cap_json,cap_len)};
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_keygen_x_json(out_json:*mut *mut u8,out_len:*mut size_t)->i32{
    use rand::RngCore;
...
/// # Safety
/// Les pointeurs C doivent être valides; les tailles associées correctes; l'appelant respecte l'ABI.
pub unsafe extern "C" fn q8_keygen_ed_json(out_json:*mut *mut u8,out_len:*mut size_t)->i32{
    use rand::rngs::OsRng;
    let mut rng=OsRng;
